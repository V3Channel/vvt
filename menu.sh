...
echo -e "\e[35m╘═════════════════════════════════════════════════════════╛\033[0m"
echo -e ""
echo -e " \033[1;92m                       Jangan pernah takut jika hari ini air mata yang menemani kita,                     \E[0m"
echo -e " \033[1;92m                       Karena mungkin semua ini sebagian dari cara Allah untuk kita,                     \E[0m"
