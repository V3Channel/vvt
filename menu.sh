...
echo -e "\e[35m╘═════════════════════════════════════════════════════════╛\033[0m"
echo -e ""
echo -e " \033[1;92mJangan pernah takut jika hari ini air mata yang menemani kita,\E[0m"
echo -e " \033[1;92mKarena mungkin semua ini sebagian dari cara Allah untuk kita,\E[0m"
echo -e " \033[1;92m             Untuk membentuk pribadi kita,\E[0m             "
echo -e " \033[1;92m    Untuk jadi orang yang kuat di saat semua dugaan,\E[0m   "
echo -e " \033[1;92m      Dan ke sedihan itu datang menghampiri kita.\E[0m      "
echo -e ""
echo -e "\e[35m╒═════════════════════════════════════════════════════════╕\033[0m"
